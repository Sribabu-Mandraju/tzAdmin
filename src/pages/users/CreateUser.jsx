...
const CreateUsers = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.mode !== "offline_mode" && !formData.razorpay_order_id) {
      toast.error(
        "Payment Check Error: Razorpay Order ID is required for online mode."
      );
      return;
    }
        ...
        >
          ...
          <div className="email-wrap  flex flex-col gap-2">
            ...
            <input
              ...
              className="border-[1px] text-black border-zinc-400 p-[10px] rounded-lg outline-[#ccc]"
          ...
          <div className="collegeId-wrap flex flex-col gap-2">
            <label htmlFor="collegeId" className="text-lg font-semibold">
              College ID
            </label>
            <input
              type="text"
          ...
          <div className="phno-wrap flex flex-col gap-2">
            <label htmlFor="phno" className="text-lg font-semibold">
              Phone Number
            </label>
            <input
              type="text"
          ...
          <div className="referredBy-wrap flex flex-col gap-2">
            <label htmlFor="referredBy" className="text-lg font-semibold">
              Referred By
            </label>
            <input
              type="text"
          ...
          <div className="idCardUrl-wrap flex flex-col gap-2">
            <label htmlFor="idCardUrl" className="text-lg font-semibold">
              CollegeID Image URL
            </label>
            <input
              type="url"
